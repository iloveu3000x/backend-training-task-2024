...
const yogaFee = 300;
const fitnessTrainingFee = 500;
const fitnessSingleTutoring = 1500;
const fitnessBudget = 3000;
...
const fitnessSingleTutoring = 1500;
const fitnessBudget = 3000;
let courseFeesTotal = yogaFee + fitnessTrainingFee + fitnessSingleTutoring;
let AlexBudget = fitnessBudget - courseFeesTotal ;

console.log(`Alex 買完課程了，他一共剩下 ${AlexBudget} 元`);
// ↓
// Alex 買完課程了，他一共剩下 100 元
...
let coursePrice = 200;
let courseNum = 14;
let setPrice = discount*coursePrice*courseNum;
...
const groupClassesFee = 150;
let machineUsePriceTotal = machineUsePrice*3;
const groupClassesTotal = groupClassesFee*2;
...
// ↓
// Anna 本週器械使用費共 150 元，團體課費用共 300 元，一共消費金額是 450元
...
a = 13; // 重新賦予了 a 變數，一個 13 的數字型別
a = b + 4; // 重新賦予了 a 變數，等於 b 變數加上 4 的值
a - b; // 僅計算了 a 變數減 b 的變數，任一變數皆無被賦予任何值，故不影響結果
b += 1; // 計算 b 變數加上 1 的值，並重新賦予 b 變數

console.log(a,b); // 輸出 a 變數與 b 變數
...
let numberArr1 = [5, 10, 15]; // 宣告陣列 numberArr1 ，初始值設定為 '5'  '10'  '15'
let numberArr2 = numberArr1; // 宣告變數 numberArr2 ，將 numberArr1 記憶體位址賦予numberArr2
numberArr2.push(20); // 變數 numberArr2 新增一個 20 的值，並也傳至 numberArr1 記憶體位址，新增了這個值
numberArr2 = [25, 30, 35]; // 將變數 numberArr2 重新賦值為一個新的陣列 '25'  '30'  '35'
console.log(numberArr1, numberArr2); // 輸出 numberArr1 與 numberArr2
// [5, 10, 15, 20]  [25, 30, 35]
