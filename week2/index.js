...
var l = '8';
// 請文字解釋為什麼
console.log(k * l > 21);　//true, JavaScript在遇到字串相乘時，會變成小貼心幫忙轉成數字型別
...
console.log(`贈品還剩下${giftNum}個`); //Bob有獲得贈品，因此贈品剩下279個
...
let calorieBurn = 0;
calorieBurn =
  activities.bike.caloriePerMin * 20 +
  activities.treadmill.caloriePerMin * 30 +
  activities.yoga.caloriePerMin * 40;
